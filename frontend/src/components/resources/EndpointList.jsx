...
export const EndpointList = () => {
    ...
    useEffect(() => {
        ...
        getResourceData('endpoints');
    }, [])
    return (
        <div className='p-8'>
            <div className='text-2xl text-gray-400 mb-4'>Endpoints</div>
            <div className='bg-zinc-600 rounded-sm shadow-md'>
                <table className='min-w-full'>
                    <thead className='border-b border-gray-700 bg-zinc-500'>
                        ...
                        <th className="text-sm font-bold text-gray-900 px-6 py-4 text-left">Endpoints</th>
                    </thead>
                    <tbody>
                        {data.map(el => (
