        ...
        <div className='bg-gray-500 rounded-sm shadow-md'>
            <table className='min-w-full'>
                <thead className='border-b border-gray-700'>
                    ...
                    <th className="text-sm font-medium text-gray-900 px-6 py-4 text-left">Completions</th>
                    <th className="text-sm font-medium text-gray-900 px-6 py-4 text-left">Conditions</th>
                </thead>
                <tbody>
                    {data.map(el => (
