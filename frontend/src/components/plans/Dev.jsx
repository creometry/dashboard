...
export const Dev = () => {
    ...
    return (
        <div className='flex justify-center items-center h-screen'>
            <div className='mr-2 bg-red-600 text-gray-100 rounded-md py-2 px-6 text-lg font-bold cursor-pointer hover:bg-red-500' onClick={() => payPlan()}>Get The Dev Plan</div>
        </div>
    )
}
