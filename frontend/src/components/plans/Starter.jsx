...
export const Starter = () => {
    ...
    return (
        <div className='flex justify-center items-center h-screen'>
            <div className='mr-2 bg-blue-600 text-gray-100 rounded-md py-2 px-6 text-lg font-bold cursor-pointer hover:bg-blue-500' onClick={() => payPlan()}>Get The Starter Plan</div>
        </div>
    )
}
